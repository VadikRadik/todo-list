    ...
    return (
      <ul className="task-filter">
        <li className="task-filter__item">
          <button
            className={buttonsClasses[TaskFilter.STATE_ALL]}
            onClick={() => this.props.onFilterSwitch(TaskFilter.STATE_ALL)}
          >
            All
          </button>
        </li>
        <li className="task-filter__item">
          <button
            className={buttonsClasses[TaskFilter.STATE_ACTIVE]}
            onClick={() => this.props.onFilterSwitch(TaskFilter.STATE_ACTIVE)}
          >
            Active
          </button>
        </li>
        <li className="task-filter__item">
          <button
            className={buttonsClasses[TaskFilter.STATE_COMPLETED]}
            onClick={() => this.props.onFilterSwitch(TaskFilter.STATE_COMPLETED)}
          >
            Completed
          </button>
        </li>
